...
"""Demonstrate usage of the spinner widget and the rounded button, oh and the remitools module"""

import logging

import remi.gui as gui
from remi import App
from remi import tools
...
if __name__ == "__main__":
    tools.start(MyApp, "A remi Spinner demo app", "Spinner!")

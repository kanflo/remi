...
# TODO: Need to filter out setting on colorpicker on active client as this closes the colorpicker on webkit browsers (iOS, macOS)
#        if 'class="color"' in from_websocket(message):
#            self._log.warning("ignoring message that would close the color picker on iOS: %s" % from_websocket(message))
#            return True
